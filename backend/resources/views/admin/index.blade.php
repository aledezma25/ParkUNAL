            ...
            <div class="col-md-4 col-lg-3 mb-4">
                <div class="card position-relative overflow-hidden">
                    ...
                    <div class="card-img-overlay d-flex flex-column justify-content-center text-center">
                        ...
                        <p class="card-text d-none d-md-block text-white">En esta sección el administrador puede gestionar
                            los roles de los usuarios.</p>
                        <a href="{{ route('roles.index') }}" class="btn btn-light mt-3">Entrar</a>
                    </div>
                    <div>
                        <h1 class="card-footer-title">Roles</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-3 mb-4">
                <div class="card position-relative overflow-hidden">
                    ...
                    <div class="card-img-overlay d-flex flex-column justify-content-center text-center">
                        ...
                        <p class="card-text d-none d-md-block text-white">En esta sección el administrador puede gestionar
                            los usuarios, crear, editar, eliminar...</p>
                        <a href="{{ route('usuarios.index') }}" class="btn btn-light mt-3">Entrar</a>
                    </div>
                    <div>
                        <h1 class="card-footer-title">Usuarios</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-3 mb-4">
                <div class="card position-relative overflow-hidden">
                    ...
                    <div class="card-img-overlay d-flex flex-column justify-content-center text-center">
                        ...
                        <p class="card-text d-none d-md-block text-white">En esta sección el administrador puede gestionar
                            los vehículos, crear, editar, eliminar...</p>
            ...
            <div class="col-md-4 col-lg-3 mb-4">
                <div class="card position-relative overflow-hidden">
                    ...
                    <div class="card-img-overlay d-flex flex-column justify-content-center text-center">
                        ...
                        <p class="card-text d-none d-md-block text-white">En esta sección el administrador puede registrar a
                            usuarios visitantes.</p>
                        <a href="{{ route('visitors.registervisited') }}" class="btn btn-light mt-3">Entrar</a>
                    </div>
                    <div>
                        <h1 class="card-footer-title">Registrar Visitantes</h1>
                    </div>
                </div>
            </div>

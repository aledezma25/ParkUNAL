...
return [
    ...
    | por la clase de validación. Algunas reglas tienen múltiples versiones, como
    | las reglas de tamaño. Puedes modificarlos según las necesidades de tu app.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar mensajes personalizados de validación para atributos
    | usando el formato "atributo.regla" para nombrar las líneas.
    |
    */
    ...
    | de los atributos con un nombre más amigable.
    |
    */
